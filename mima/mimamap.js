let testMimaMap = {
	initialBlackboard: {
		...
		// ". Small in its sky hangs the world it belongs to" when the vision has
		// a host world (atom/ocean/waterfall…), else "" — woven into worldOpen.
		hostline: "",
	  status: "#stuff#"},
		colour: "red",
		interest:5,
	...
	grammar: {
		...
		detour1: ["life and death","what is life","what is death","mortality","is there an afterlife","meaning of life","what happens when we die"],
				detour2: ["existing","existence","what does it mean to exist","to exist","being alive","what is being","why do we exist","exist"],
						...
						// #/robe/hostline# names the tiny host world some visions hang in
						// their sky (set by app.js on entry; "" when there is none).
						worldOpen: ["Here, #smek#... Mima has kept #/robe/subject# close a long while#/robe/hostline#","Far out where the light grows thin, Mima keeps #/robe/subject#, and leans toward it now and then","Let Mima show you something, #smek#... #/robe/subject#, here, in the held dark#/robe/hostline#","There is #/robe/subject# Mima drifts to when the night grows heavy... look#/robe/hostline#","Somewhere real, or only remembered, #smek#, here is #/robe/subject#","Mima minds a few small wonders in the dark... here is #/robe/subject#, one Mima loves#/robe/hostline#","There — #/robe/subject#, far, and near, and entirely itself, #smek#","Come close, #smek#... Mima has been keeping company with #/robe/subject##/robe/hostline#"],
